...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function srcAppAboutAboutDialogTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AboutDialog", function () {
      return AboutDialog;
    });
    /* harmony import */
    ...
    var AboutDialog = function AboutDialog(dialogRef, data) {
    ...
    AboutDialog.ɵfac = function AboutDialog_Factory(t) {
      return new (t || AboutDialog)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"]));
    };

    AboutDialog.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: AboutDialog,
      selectors: [["about-dialog"]],
      decls: 19,
      vars: 0,
      consts: [["mat-dialog-title", ""], ["mat-dialog-content", ""], ["href", "https://twitter.com/DysonLogos/status/1258788823263215616", "target", "_blank"], ["href", "https://www.gnu.org/licenses/gpl-3.0-standalone.html", "target", "_blank"], ["href", "https://github.com/spheras/dungeondraw", "target", "_blank"]],
      template: function AboutDialog_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AboutDialog, [{
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_util_util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/util/util */
    "./src/util/util.ts");
    /* harmony import */


    var _styles_draw_styles__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../styles/draw.styles */
    "./src/styles/draw.styles.ts");
    /* harmony import */


    var _about_about_dialog__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./about/about.dialog */
    "./src/app/about/about.dialog.ts");
    /* harmony import */
    ...
    function AppComponent_button_9_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AppComponent_button_9_Template_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r10);

          var style_r8 = ctx.$implicit;

          var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

          return ctx_r9.setStyle(style_r8);
        });
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(dialog) {
        ...
        this.dialog = dialog;
        this.title = 'dungeondraw'; // flag to know if it is drawing or not
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngAfterViewInit() {
          ...
          Object(src_util_util__WEBPACK_IMPORTED_MODULE_2__["animateCSS"])('.title', "lightSpeedInLeft").then(function (m) {
            Object(src_util_util__WEBPACK_IMPORTED_MODULE_2__["animateCSS"])('.title', "lightSpeedOutRight").then(function (m) {
              document.querySelector('.title').remove();
            });
          });
          var linecap = "round";
          var linejoin = "round"; //all the canvas will set a 4K dimmensions

          var fourkwidth = 4096;
          var fourkheight = 2160;
          ...
          var element = document.querySelector(".transparencyPanel");
          element.style.width = "".concat(fourkwidth, "px");
          element.style.height = "".concat(fourkheight, "px");
        ...
        value: function setStyle(style) {
          ...
          this.selectedStyle = style; //setting the draw style

          this.loadImage("assets/patterns/".concat(style.pattern1)).then(function (image3) {
            _this.loadImage("assets/patterns/".concat(style.pattern2)).then(function (image1) {
              var linecap = "round";
              var linejoin = "round";
              var element = document.querySelector("mat-drawer-container");
              element.style.background = "url(\"/assets/patterns/".concat(style.pattern1, "\")");
              element = document.querySelector(".transparencyPanel");
              element.style.backgroundColor = "rgba(255, 255, 255, ".concat(style.backgroundOpacity, ")");
              _this.ctx3 = _this.myCanvas3.nativeElement.getContext('2d');

              var pat3 = _this.ctx3.createPattern(image3, "repeat");

              _this.ctx3.fillStyle = pat3;
              _this.ctx3.lineWidth = _this.selectedStyle.lineWidth3;
              _this.ctx3.lineJoin = linejoin;
              _this.ctx3.lineCap = linecap;
              _this.ctx3.strokeStyle = pat3;
              _this.ctx2 = _this.myCanvas2.nativeElement.getContext('2d');
              _this.ctx2.lineWidth = _this.selectedStyle.lineWidth2;
              _this.ctx2.lineJoin = linejoin;
              _this.ctx2.lineCap = linecap;
              _this.ctx1 = _this.myCanvas1.nativeElement.getContext('2d');

              var pat1 = _this.ctx3.createPattern(image1, "repeat");

              _this.ctx1.lineWidth = _this.selectedStyle.lineWidth1;
              _this.ctx1.lineJoin = linejoin;
              _this.ctx1.lineCap = linecap;
              _this.ctx1.strokeStyle = pat1;
              _this.ctx1.fillStyle = pat1;
            });
          });
        }
        /**
        ...
        key: "saveDraw",
        value: function saveDraw() {
          var width = this.myCanvas1.nativeElement.width;
          var height = this.myCanvas1.nativeElement.height; //discovering the boundaries of the draw

          var data = this.ctx1.getImageData(0, 0, width, height).data;
          var wf = width * 4;
          var lowestX = width;
          var lowestY = height;
          var maxX = 0;
          ...
          var saveWidth = maxX - lowestX;
          var saveHeight = maxY - lowestY;
          ...
          hidden_ctx.drawImage(this.myCanvas3.nativeElement, lowestX, lowestY, saveWidth, saveHeight, 0, 0, saveWidth, saveHeight); //Create a download URL for the data, and download
        ...
        value: function onMouseDown(e) {
          ...
          this.isDrawing = true;
          var canvasX = e.pageX - this.myCanvas3.nativeElement.offsetLeft + this.myCanvas3.nativeElement.parentElement.scrollLeft;
          var canvasY = e.pageY - this.myCanvas3.nativeElement.offsetTop + this.myCanvas3.nativeElement.parentElement.scrollTop;
          this.lastPoint = {
            x: canvasX,
            y: canvasY
          };
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("mousemove", function AppComponent_Template_canvas_mousemove_67_listener($event) {
            return ctx.onMouseMove($event);
          })("mouseup", function AppComponent_Template_canvas_mouseup_67_listener() {
            return ctx.onMouseUp();
          })("mousedown", function AppComponent_Template_canvas_mousedown_67_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("mousedown", function AppComponent_Template_button_mousedown_70_listener($event) {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_material_menu__WEBPACK_IMPORTED_MODULE_9__["MatMenuModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_8__["MatSelectModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_6__["MatButtonModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_7__["MatIconModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_5__["MatSidenavModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_10__["MatDialogModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_11__["MatInputModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["FormsModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_13__["MatTableModule"]]]
    });
  ...
  /***/
  function srcStylesDrawStylesTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/spheras/jasdata/development/projects/dungeondraw/dungeondraw/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
